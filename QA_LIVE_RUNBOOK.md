...
3. Upload constraints: validate rejection for non-allowed MIME or files larger than 1 MB.
...
5. Publish change note to QA team.
6. If adding new help images, publish them with `scripts/publish-asset.ps1`, verify the GitHub URL, and update `mediaUrl` with Raw URL (main).
